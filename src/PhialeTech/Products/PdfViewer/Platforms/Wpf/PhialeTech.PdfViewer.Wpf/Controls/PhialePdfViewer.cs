...
namespace PhialeTech.PdfViewer.Wpf.Controls
{
    public sealed class PhialePdfViewer : OverlayableWebComponentControlBase, IPdfViewer
    {
        ...
        public PhialePdfViewer()
            : this(new WpfWebComponentHostFactory(), new PdfViewerOptions())
        {
        }
        ...
        public PhialePdfViewer(IWebComponentHostFactory hostFactory, PdfViewerOptions options = null)
        {
            ...
            var hostElement = _host as FrameworkElement;
            if (hostElement == null)
            ...
            hostElement.HorizontalAlignment = HorizontalAlignment.Stretch;
            hostElement.VerticalAlignment = VerticalAlignment.Stretch;
            hostElement.MinWidth = 0d;
            hostElement.MinHeight = 0d;

            InitializeOverlaySurface(hostElement, new Thickness(0d), new Thickness(12), new CornerRadius(14));
            Loaded += HandleLoaded;
        }
