// PhialeGis.Library.WpfUi.Controls/PhialeDslEditor.Properties.cs
...
namespace PhialeGis.Library.WpfUi.Controls
{
    public sealed partial class PhialeDslEditor
    {
        ...
        private static IRenderingComposition ResolveDrawAdapter(object value)
        {
            ...
            // WPF drawbox wrapper exposing CompositionAdapter:
            if (value is PhialeDrawBox box && box.CompositionAdapter is IRenderingComposition rc2)
                return rc2;
