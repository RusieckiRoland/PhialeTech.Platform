...
namespace PhialeTech.Components.Shared.Services
{
    public sealed class DemoFeatureCatalog
    {
        ...
        private static readonly IReadOnlyList<DemoExampleDefinition> ExampleDefinitions = new[]
        {
            ...
            new DemoExampleDefinition("web-component-scroll-host", "web-components", DemoTextKeys.SectionOverview, 0, 11, DemoTextKeys.ExampleWebComponentScrollHostTitle, DemoTextKeys.ExampleWebComponentScrollHostDescription, "#0F766E", new[] { "webview2", "composition", "scroll", "viewport", "focus", "host" }, drawerGroupId: "web-components"),
