...
namespace PhialeTech.Components.Shared.Services
{
    public sealed class DemoFeatureCatalog
    {
        ...
        private static readonly IReadOnlyList<DemoExampleDefinition> ExampleDefinitions = new[]
        {
            ...
            new DemoExampleDefinition("custom-detail", "grid", DemoTextKeys.SectionOverview, 0, 6, DemoTextKeys.ExampleCustomDetailTitle, DemoTextKeys.ExampleCustomDetailDescription, "#2563EB", new[] { "custom detail", "row detail", "usercontrol", "preview" }),
            new DemoExampleDefinition("active-layer-selector", "active-layer-selector", DemoTextKeys.SectionOverview, 0, 7, DemoTextKeys.ExampleActiveLayerSelectorTitle, DemoTextKeys.ExampleActiveLayerSelectorDescription, "#2F80ED", new[] { "layers", "selector", "active", "visibility", "snapping" }),
            ...
            new DemoExampleDefinition("web-host", "web-components", DemoTextKeys.SectionOverview, 0, 8, DemoTextKeys.ExampleWebHostTitle, DemoTextKeys.ExampleWebHostDescription, "#0EA5E9", new[] { "web", "host", "browser", "cef", "webview2", "javascript" }, drawerGroupId: "web-components"),
            new DemoExampleDefinition("pdf-viewer", "web-components", DemoTextKeys.SectionOverview, 0, 9, DemoTextKeys.ExamplePdfViewerTitle, DemoTextKeys.ExamplePdfViewerDescription, "#2563EB", new[] { "pdf", "viewer", "print", "pdfjs", "webhost", "search" }, drawerGroupId: "web-components"),
            new DemoExampleDefinition("report-designer", "web-components", DemoTextKeys.SectionOverview, 0, 10, DemoTextKeys.ExampleReportDesignerTitle, DemoTextKeys.ExampleReportDesignerDescription, "#0F766E", new[] { "report", "designer", "print", "preview", "json", "webhost" }, drawerGroupId: "web-components"),
            new DemoExampleDefinition("monaco-editor", "web-components", DemoTextKeys.SectionOverview, 0, 11, DemoTextKeys.ExampleMonacoEditorTitle, DemoTextKeys.ExampleMonacoEditorDescription, "#1D4ED8", new[] { "monaco", "editor", "code", "yaml", "webhost", "javascript" }, drawerGroupId: "web-components"),
            new DemoExampleDefinition("document-editor", "web-components", DemoTextKeys.SectionOverview, 0, 12, DemoTextKeys.ExampleDocumentEditorTitle, DemoTextKeys.ExampleDocumentEditorDescription, "#0B8F6A", new[] { "documenteditor", "tiptap", "markdown", "html", "json", "webhost" }, drawerGroupId: "web-components"),
            new DemoExampleDefinition("web-component-scroll-host", "web-components", DemoTextKeys.SectionOverview, 0, 13, DemoTextKeys.ExampleWebComponentScrollHostTitle, DemoTextKeys.ExampleWebComponentScrollHostDescription, "#0F766E", new[] { "webview2", "composition", "scroll", "viewport", "focus", "host" }, drawerGroupId: "web-components"),
