...
namespace PhialeTech.Components.Shared.Services
{
    public sealed class DemoFeatureCatalog
    {
        ...
        private static readonly IReadOnlyList<DemoExampleDefinition> ExampleDefinitions = new[]
        {
            ...
            new DemoExampleDefinition("yaml-document", "yaml-ui", DemoTextKeys.SectionInputs, 4, 1, DemoTextKeys.ExampleYamlDocumentTitle, DemoTextKeys.ExampleYamlDocumentDescription, "#5B21B6", new[] { "yaml", "document", "layout", "actions", "wpf", "renderer" }, drawerGroupId: "yaml-ui"),
            ...
            new DemoExampleDefinition("yaml-generate-form", "yaml-ui", DemoTextKeys.SectionInputs, 4, 3, DemoTextKeys.ExampleYamlGenerateFormTitle, DemoTextKeys.ExampleYamlGenerateFormDescription, "#7E22CE", new[] { "yaml", "generate", "form", "runtime", "wpf", "dialog" }, drawerGroupId: "yaml-ui"),
            ...
            new DemoExampleDefinition("third-party-licenses", "license", DemoTextKeys.SectionOverview, 0, 12, DemoTextKeys.ExampleThirdPartyLicensesTitle, DemoTextKeys.ExampleThirdPartyLicensesDescription, "#0F766E", new[] { "licenses", "third-party", "pdfjs", "jsbarcode", "qrcode", "monaco" }, drawerGroupId: "license"),
